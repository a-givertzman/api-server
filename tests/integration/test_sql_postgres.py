...
class TestSqlPostgres(unittest.TestCase):
    ...
    #         {
    #             'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test", "sql@@@": "select 1;"}}',
    #             'output': {"auth_token": "123zxy456!@#", "id": "123", 'debug': True, 'data': [], 'error': '[ApiQuerySql.fromJson] field \'sql\' of type String not found', 'query': {"auth_token":"123zxy456!@#","id":"123","debug":True,"sql":{"database":"db_postgres_test", "sql@@@": "select 1;"}}},
    #         },
    #         {
    #             'input': r'{"auth_token":"123zxy456!@#","id":"456","sql":{"database":"db_postgres_test", "sql@@@": "select 1;"}}',
    #             'output': {"auth_token": "123zxy456!@#", "id": "456", 'data': [], 'error': '[ApiQuerySql.fromJson] field \'sql\' of type String not found', 'query': None},
    #         },
    #         {
    #             'input': r'{"auth_token":"123zxy456!@#","id":"789","debug":true,"sql":{"database@@@":"db_postgres_test","sql":"select 1;"}}',
    #             'output': {"auth_token": "123zxy456!@#", "id": "789", 'debug': True, 'data': [], 'error': '[ApiQuerySql.fromJson] field \'database\' of type String not found', 'query': {"auth_token":"123zxy456!@#","id":"789","debug":True,"sql":{"database@@@":"db_postgres_test","sql":"select 1;"}}},
    #         },
    #         {
    #             'input': r'{"auth_token":"123zxy456!@#","id":"789","sql":{"database@@@":"db_postgres_test","sql":"select 1;"}}',
    #             'output': {"auth_token": "123zxy456!@#", "id": "789", 'data': [], 'error': '[ApiQuerySql.fromJson] field \'database\' of type String not found', 'query': None},
    #         },
    #     ]
    #     for i, entry in enumerate(data_maps):
    ...
    #             'output': {"auth_token": "123zxy456!@#", "id": "111", 'data': [], 'error': 'ApiServer.build | Error: Database service with the name \'py-test\' can\'t be found', 'query': None},
    #         },
    #         {
    #             'input': r'{"auth_token":"123zxy456!@#","id":"222","debug":true,"sql":{"database":"py-test","sql":"select id from do_data;"}}',
    #             'output': {"auth_token": "123zxy456!@#", "id": "222", 'data': [], 'error': 'ApiServer.build | Error: Database service with the name \'py-test\' can\'t be found', 'query': {"database":"py-test","sql":"select id from do_data;"}},
    #         },
    #         {
    #             'input': r'{"auth_token":"123zxy456!@#","id":"333","debug":true,"sql":{"database":"executable-test","sql":"select id from do_data;"}}',
    #             'output': {"auth_token": "123zxy456!@#", "id": "333", 'data': [], 'error': 'ApiServer.build | Error: Database service with the name \'executable-test\' can\'t be found', 'query': {"database":"executable-test","sql":"select id from do_data;"}},
    #         },
    #         {
    #             'input': r'{"auth_token":"123zxy456!@#","id":"444","sql":{"database":"executable-test","sql":"select id from do_data;"}}',
    #             'output': {"auth_token": "123zxy456!@#", "id": "444", 'data': [], 'error': 'ApiServer.build | Error: Database service with the name \'executable-test\' can\'t be found', 'query': None},
    #         },
    #     ]
    #     for i, entry in enumerate(data_maps):
    ...
    def test_sql_basic_types(self):
        data_maps = [
            {
                'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE boolfield = true;"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"boolfield": True}, 'error': {'message': ''}, 'query': r'{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE boolfield = true;"}'},
            },
            {
                'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int2field = -32768;"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"int2field": -32768}, 'error': {'message': ''}, 'query': r'{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int2field = -32768;"}'},
            },
            {
                'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int2field = 32767;"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"int2field": 32767}, 'error': {'message': ''}, 'query': r'{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int2field = 32767;"}'},
            },

            {
                'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int4field = -2147483648;"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"int4field": -2147483648}, 'error': {'message': ''}, 'query': r'{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int4field = -2147483648;"}'},
            },
            {
                'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int4field = 2147483647;"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"int4field": 2147483647}, 'error': {'message': ''}, 'query': r'{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int4field = 2147483647;"}'},
            },
            {
                'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int8field = -9223372036854775808;"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"int8field": -9223372036854775808}, 'error': {'message': ''}, 'query': r'{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int8field = -9223372036854775808;"}'},
            },
            {
                'input': r'{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int8field = 9223372036854775807;"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"int8field": 9223372036854775807}, 'error': {'message': ''}, 'query': r'{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE int8field = 9223372036854775807;"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE float4field = \'-9.123456e3\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"float4field": -9.123456e3}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE float4field = \'-9.123456e3\';"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE float8field = \'9.123456789012345e3\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"float8field": 9.123456789012345e3}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE float8field = \'9.123456789012345e3\';"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE charfield = \'1\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"charfield": '1'}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE charfield = \'1\';"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE bpcharfield = \'1234\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"bpcharfield": '1234'}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE bpcharfield = \'1234\';"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE bpvarcharfield = \'12345678\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"bpvarcharfield": '12345678'}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE bpvarcharfield = \'12345678\';"}'},
            },
            {
                'input': f'{{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE varcharfield = \'{longString}\';"}}}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"varcharfield": longString}, 'error': {'message': ''}, 'query': f'{{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE varcharfield = \'{longString}\';"}}'},
            },
            {
                'input': f'{{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE namefield = \'{longString[:63]}\';"}}}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"namefield": longString[:63]}, 'error': {'message': ''}, 'query': f'{{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE namefield = \'{longString[:63]}\';"}}'},
            },
            {
                'input': f'{{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE textfield = \'{longString}\';"}}}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"textfield": longString}, 'error': {'message': ''}, 'query': f'{{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE textfield = \'{longString}\';"}}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE timestampfield = \'2004-10-19 10:23:54\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"timestampfield": '2004-10-19T10:23:54'}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE timestampfield = \'2004-10-19 10:23:54\';"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE timestampzfield = \'2004-10-19 10:23:54+2\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"timestampzfield": '2004-10-19T08:23:54Z'}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE timestampzfield = \'2004-10-19 10:23:54+2\';"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE datefield = \'2004-10-19\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"datefield": '2004-10-19'}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE datefield = \'2004-10-19\';"}'},
            },
            {
                'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE timefield = \'10:23:54\';"}}',
                'output': {"auth_token": "123zxy456!@#", "id": "123", 'data': {"timefield": '10:23:54'}, 'error': {'message': ''}, 'query': '{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE timefield = \'10:23:54\';"}'},
            },
        ]
        for i, entry in enumerate(data_maps):
            data_bytes = bytes(entry['input'], encoding='utf-8')
    ...
    #     data_maps = [
    #         {
    #             'input': '{"auth_token":"123zxy456!@#","id":"123","debug":true,"sql":{"database":"db_postgres_test","sql":"SELECT * FROM test WHERE bool_array_field IS NOT NULL;"}}',
