...
UPDATE compartment SET density=1.025, mass=87.1, use_max_m_f_s=TRUE WHERE ship_id=2 AND space_id=217;
UPDATE compartment SET density=1.025, mass=104, use_max_m_f_s=TRUE WHERE ship_id=2 AND space_id=218;
...
UPDATE hold_compartment SET density=0.682687, mass=4299.6, category_id=12 WHERE ship_id=2 AND group_id=(SELECT id FROM hold_group WHERE ship_id=2 AND space_id=1001);
UPDATE hold_compartment SET density=0.683519356, mass=5098.2, category_id=12 WHERE ship_id=2 AND group_id=(SELECT id FROM hold_group WHERE ship_id=2 AND space_id=1002);

UPDATE hold_compartment SET density=0.682687, mass=0, category_id=12 WHERE ship_id=2 AND group_id=(SELECT id FROM hold_group WHERE ship_id=2 AND space_id=1001);
UPDATE hold_compartment SET density=0.683519356, mass=0, category_id=12 WHERE ship_id=2 AND group_id=(SELECT id FROM hold_group WHERE ship_id=2 AND space_id=1002);
