...
UPDATE compartment SET density=0.97, mass=6.6, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=303;
UPDATE compartment SET density=0.97, mass=15, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=304;
UPDATE compartment SET density=0.97, mass=7.8, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=305;
UPDATE compartment SET density=0.97, mass=10, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=306;
...
UPDATE compartment SET density=0.97, mass=2, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=301;
UPDATE compartment SET density=0.97, mass=17, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=302;
UPDATE compartment SET density=0.85, mass=0.5, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=400;
UPDATE compartment SET density=0.85, mass=4.4, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=401;
UPDATE compartment SET density=0.85, mass=3, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=402;
UPDATE compartment SET density=0.9, mass=1.8, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=501;
UPDATE compartment SET density=0.9, mass=0.4, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=504;
UPDATE compartment SET density=0.97, mass=6.7, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=308;
UPDATE compartment SET density=1, mass=0.3, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=700;
UPDATE compartment SET density=1, mass=8.4, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=704;
UPDATE compartment SET density=1, mass=6, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=705;
UPDATE compartment SET density=1, mass=6, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=706;
UPDATE compartment SET density=1, mass=3.6, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=601;
UPDATE compartment SET density=1, mass=3.6, use_max_m_f_s=FALSE WHERE ship_id=2 AND space_id=602;
