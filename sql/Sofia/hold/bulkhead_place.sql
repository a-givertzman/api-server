...
VALUES
  (2, 'SP101', 'Трюм 1.  По-походному ', 'Hold 1.Stowage Position', (SELECT id FROM hold_group WHERE space_id=1001), 73.358, 74.673, 74.016, 0.000, 6.530),
  (2, 'SP102', 'Трюм 1.  По-походному ', 'Hold 1.Stowage Position', (SELECT id FROM hold_group WHERE space_id=1001), 74.673, 75.988, 75.331, 0.000, 6.530),
  ...
  (2, 'SP201', 'Трюм №2.  По-походному ', 'Hold 2.Stowage Position', (SELECT id FROM hold_group WHERE space_id=1002), 18.600, 19.91, 19.257, 0.00, 6.530),
  (2, 'SP202', 'Трюм №2.  По-походному ', 'Hold 2.Stowage Position', (SELECT id FROM hold_group WHERE space_id=1002), 19.91, 21.230, 20.572, 0.00, 6.530),
