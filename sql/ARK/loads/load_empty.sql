...
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 8;      -- Балласт 2 ДД
...
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 11;     -- Балласт 3 ДД
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 12;     -- Балласт 4 Пр.Б
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 13;     -- Балласт 4 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 14;     -- Балласт 4 ДД
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 15;     -- Балласт 5 Пр.Б
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 16;     -- Балласт 5 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 17;     -- Балласт 5 ДД
...
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 20;     -- Балласт 6 ДД
...
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 23;     -- Балласт 7 ДД
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 24;  -- Цистерна расходного топлива 1 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 25;  -- Цистерна расходного топлива 2 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 26; -- Цистерна запасного топлива 1 Пр.Б
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 27; -- Цистерна запасного топлива 2 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 28;-- Цистерна запасного топлива 3 Пр.Б
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 29;-- Цистерна запасного топлива 3 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 30;  -- Цистерна переливная ДП
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 31;  -- Цистерна расходного топлива АДГ Пр.Б
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 32; -- Цистерна пресной воды 1 ДП (носовая)
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 33;  -- Цистерна пресной воды 2 Пр.Б (кормовая)
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 34;  -- Цистерна питьевой воды 1 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 35;  -- Цистерна питьевой воды 2 ЛБ
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 36;  -- Цистерна запасного масла ГД
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 37;  -- Цистерна запасного масла ДГ
