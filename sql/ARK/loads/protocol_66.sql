...
UPDATE compartment SET mass = 5.51 WHERE ship_id = 1 AND space_id = 24;
UPDATE compartment SET mass = 5.51 WHERE ship_id = 1 AND space_id = 25;
UPDATE compartment SET mass = 34.98 WHERE ship_id = 1 AND space_id = 26;
UPDATE compartment SET mass = 35.10 WHERE ship_id = 1 AND space_id = 27;
UPDATE compartment SET mass = 53.4243 WHERE ship_id = 1 AND space_id = 28;
UPDATE compartment SET mass = 53.4243 WHERE ship_id = 1 AND space_id = 29;
UPDATE compartment SET mass = 53.4243 WHERE ship_id = 1 AND space_id = 29;
UPDATE compartment SET mass = 0.00 WHERE ship_id = 1 AND space_id = 30;
UPDATE compartment SET mass = 1.06 WHERE ship_id = 1 AND space_id = 31;
UPDATE compartment SET mass = 45.09 WHERE ship_id = 1 AND space_id = 32;
UPDATE compartment SET mass = 3.94 WHERE ship_id = 1 AND space_id = 33;
UPDATE compartment SET mass = 3.71 WHERE ship_id = 1 AND space_id = 34;
UPDATE compartment SET mass = 3.71 WHERE ship_id = 1 AND space_id = 35;
UPDATE compartment SET mass = 2.49 WHERE ship_id = 1 AND space_id = 36;
UPDATE compartment SET mass = 2.49 WHERE ship_id = 1 AND space_id = 37;
UPDATE compartment SET mass = 0 WHERE ship_id = 1 AND space_id = 38;
UPDATE compartment SET mass = 32.84 WHERE ship_id = 1 AND space_id = 39;
