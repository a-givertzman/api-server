...
--     (project_id, ship_id, space_id, name_rus)
-- VALUES
--     (NULL, 1, 1, 'Трюм');
-- --
-- INSERT INTO bulkhead_place
--     (project_id, ship_id, space_id, name_rus, hold_group_id, bound_x1, bound_x2, mass_shift_x, mass_shift_y, mass_shift_z)
-- VALUES
--     (NULL, 1, 61, '113 шп.',  1,  12.696,     13.086,     12.87,  0,  4.53),
--     (NULL, 1, 62, '51 шп.',   1,  -27.604,    -27.214,    -27.43, 0,  4.53),
--     (NULL, 1, 63, '28 шп.',   1,  -42.749,    -42.359,    -42.57, 0,  4.53),
--     (NULL, 1, 64, '27 шп.',   1,  -43.204,    -42.814,    -42.96, 0,  4.53);
-- --
-- INSERT INTO hold_part
--     (project_id, ship_id, space_id, group_id, group_index, left_bulkhead_place_id, right_bulkhead_place_id, bound_x1, bound_x2, volume_max, svg_paths)
-- VALUES
--     (NULL, 1, 51, 1, 1,   1,      NULL,   12.956,     37.656,     1848.75,
--         '{
...
--         }'
--     ),
--     (NULL, 1, 52, 1, 2,   2,      1,      -27.344,    12.956,     3074.62,
--         '{
...
--         }'
--     ),
--     (NULL, 1, 53, 1, 3,   NULL,   2,      -44.194,    -27.344,    1292.0,
--         '{
...
--     (project_id, ship_id, name_rus, mass, category_id)
-- VALUES
--     (NULL, 1, 'Зерновая переборка №1', 12.0, 22),
--     (NULL, 1, 'Зерновая переборка №2', 12.0, 22);