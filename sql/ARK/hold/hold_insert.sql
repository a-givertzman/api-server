...
VALUES
    ...
    (3, 63, '28 шп.',   1,  -42.749,    -42.359,    -42.57, 0,  4.53),
    (4, 64, '27 шп.',   1,  -43.204,    -42.814,    -42.96, 0,  4.53);
--
INSERT INTO hold_part
    (id, space_id, group_id, group_index, left_bulkhead_place_id, right_bulkhead_place_id, bound_x1, bound_x2, volume_max, svg_paths)
VALUES
    (1, 51, 1, 1,   NULL,   1,      12.956,     37.656,     1848.75,
        '{
    ...
    (2, 52, 1, 2,   1,      2,      -27.344,    12.956,     3074.62,
        '{
    ...
    (3, 53, 1, 3,   2,      NULL,   -44.194,    -27.344,    1292.0,
        '{
