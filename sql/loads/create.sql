...
CREATE TABLE if not exists compartment (
  ...
  CONSTRAINT compartment_name_rus_unique UNIQUE NULLS NOT DISTINCT (project_id, ship_id, name_rus),
  CONSTRAINT compartment_name_rus_check CHECK(char_length(name_rus) <= 100),
  CONSTRAINT compartment_ab_rus_unique UNIQUE NULLS NOT DISTINCT (project_id, ship_id, ab_rus),
  CONSTRAINT compartment_ab_rus_check CHECK(char_length(ab_rus) <= 50),
  CONSTRAINT compartment_name_engl_unique UNIQUE NULLS NOT DISTINCT (project_id, ship_id, name_engl),
  CONSTRAINT compartment_name_engl_check CHECK(char_length(name_engl) <= 100),
  CONSTRAINT compartment_ab_engl_unique UNIQUE NULLS NOT DISTINCT (project_id, ship_id, ab_engl),
