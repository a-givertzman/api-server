-- Заполнение данных по грузам в отсеках и цистернах 
...
BEGIN 
    ...
    IF r1.space_id IS NOT NULL THEN 
        res.level = r1.level;  
    ...
    ELSE -- если не нашли ищем два ближайших и интерполируем
        ...
        IF r2.space_id IS NULL THEN
            ...
            res.m_f_s_x = r1.trans_inertia_moment_self;
            res.m_f_s_y = r1.long_inertia_moment_self; 
        ELSIF r1.space_id IS NULL THEN
            res.level = r2.level;  
...
BEGIN 
    ...
    ORDER BY t.trans_inertia_moment_self DESC LIMIT 1;
