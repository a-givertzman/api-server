...
class TestCommon(unittest.TestCase):
    def test_common_non_utf8_encoding(self):
        data_maps = [
            {
                'input': r'{"authToken":"123zxy456!@#","id":"123","sql":{"database":"database","sql":"select * from do_data;"}}',
            ...
            {
                'input': r'{"authToken":"123zxy456!@#","id":"123","python":{"script":"py-test","params":{"a": 4, "b": 7}}}',
